...
//$categories = get_terms('cmfaq_category', array('include' => \CM\CMFAQ_Settings::get('cmfaq_front_categories', array())));
$categories = get_terms('cmfaq_category');

$i = 0;

$posts_per_page = intval(\CM\CMFAQ_Settings::get('cmfaq_front_num_questions', 5));
...
foreach ($categories as $category):
    ...
    if ($is_more):
        ...
        echo '<a class="cmfaq-tile-more-link" href="' . esc_attr(get_category_link($category)) . '">' . \CM\CMFAQ_Settings::get('cmfaq_label_tiles_show_more', 'Show more »') . '</a>';
