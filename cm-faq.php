...
if (!defined('CMFAQ_RELEASE_NOTES_URL')) {
    define('CMFAQ_RELEASE_NOTES_URL', 'https://www.cminds.com/wordpress-plugins-library/faq-plugin-for-wordpress-by-creativeminds/');
}
...
include_once plugin_dir_path(__FILE__) . 'classes/Wizard.php';
include_once plugin_dir_path(__FILE__) . 'settings/CMFAQ_Settings.php';
...
CMFAQ_Base::init();
CMFAQ_Admin::init();
add_action('wp_loaded',['CM\CMFAQ_Settings','init']);
CMFAQ_SetupWizard::init();